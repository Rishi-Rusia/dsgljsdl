...
//       if (data.question !== lastQuestionRef.current) {
//         setSubmitted(false);
//         setSelected(null);
//         setCurrentOption('');
...
//       <h2 className="text-md font-medium text-gray-800 mb-4">{props.question}</h2>
//       <div className="space-y-2">
//         {props.options.map((option, id) => {
//           id = id + 1;
//           return <div
//             key={id}
//             className={`relative rounded-lg border ${selected === id ? 'border-purple-600' : 'border-gray-200'
...
//             )}
//             <label
//               className={`relative z-10 flex items-center gap-3 p-3 cursor-pointer ${submitted ? 'text-white' : 'text-gray-800'
//                 }`}
//               onClick={() => {
//                 if (!submitted) {
//                   setSelected(id);
...
//             >
//               <div className={`w-6 h-6 flex items-center justify-center rounded-full text-xs font-bold ${selected === id || submitted ? 'bg-purple-600 text-white' : 'bg-gray-300 text-gray-700'
//                 }`}>
//                 {id}
//               </div>
//               <span className="text-black text-sm font-medium flex-1">{option.option}</span>
//               {submitted && (
...
useEffect(() => {
  ...
  // Reset on question change (from parent props)
  useEffect(() => {
